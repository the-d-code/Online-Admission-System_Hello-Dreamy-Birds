...
<head>
  ...
  <title>Hello Dreamy Birds| View Form</title>
...
<tr>
  ...
  <tr>
  <th>Student Pic</th>
  <td><img src="../user/pages/userimages/<?php echo $row['UserPic'];?>" width="200" height="150"></td>
    <th>Father Name</th>
...
<tr>
  ...
  <td><a href="../user/pages/userdocs/<?php echo $row['TransferCertificate'];?>" target="_blank">View File </a></td>
</tr>
<tr>
  <th>10th Marksheet</th>
  <td><a href="../user/pages/userdocs/<?php echo $row['TenMarksheeet'];?>" target="_blank">View File </a></td>

  <th>12th Marksheet</th>
  <td><a href="../user/pages/userdocs/<?php echo $row['TwelveMarksheet'];?>" target="_blank">View File </a></td>
  </tr>
  <tr>
...
<?php if($row['GraduationCertificate']==""){ ?>
  NA
<?php } else{ ?>
    <a href="../user/pages/userdocs/<?php echo $row['GraduationCertificate'];?>" target="_blank">View File </a>
<?php } ?>
  </td>
...
<?php if($row['PostgraduationCertificate']==""){ ?>
  NA
<?php } else{ ?>
    <a href="../user/pages/userdocs<?php echo $row['PostgraduationCertificate'];?>" target="_blank">View File </a>
<?php } ?>
  </td>
</tr>
</table>
