...
<head>
  ...
  <title>
Hello Dreamy Birds | Password Reset
  </title>
  <!--     Fonts and icons     -->
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-secondary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Enter Details For Reset Password</h4>
    ...
    echo $msg;
                    ...
                    <form class="form-horizontal" action=""   method="post" >
                      ...
                      <div class="row">
                        ...
                        <a href="login.php" class="btn btn-success btn-lg btn-block"><i class="ft-unlock"></i> Login</a></div>
                      </div>
                    </form>
              </div>
            </div>
